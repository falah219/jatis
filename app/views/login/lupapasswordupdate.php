            ...
            <div class="modal-content br-15" style="background-color: #FF6C20;">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <center>
                                <h5 class="white mt-5">Sandi berhasil diperbarui.</h5>
            ...
            <div class="container">
                ...
                <div class="card  mt-5 card-lupa2 br-10">
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <div class="container" style="width: 70%; margin-top: 17%">
                                <h4 class="mb-3">Sandi Baru</h4>
                                <form action="">
                                    <input type="password" style="border-color: #EC7335; width: 400px" placeholder="Masukkan password baru" class="form-control fst-italic br-10" id="" aria-describedby="">
                                    <label for="" class="h4 mt-3">Konfirmasi Sandi Baru</label>
                                    <input type="password" style="border-color: #EC7335; width: 400px" placeholder="Masukkan password baru" class="form-control fst-italic br-10" id="" aria-describedby="">
                                </form>
                                <center>
