...
<body>
            ...
            <div class="modal-content br-15" style="background-color: #FF6C20;">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <center>
                                <h5 class="white mt-5">Berhasil !!!</h5>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <img src="../img/bg-login.png" style="width: 676px; margin-top: 10%;" alt="">
        </div>
        ...
        <div class="col-md-6">
            <div class="bg-orange">
                <div class="d-flex justify-content-end me-3 mt-3">
                    ...
                    <button class="btn btn-white3 br-15"> Daftar sini !</button>
                </div>
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="form-group mb-4">
                                    <label for="username" class="h5 white">Nama Pengguna </label>
                                    <input type="text" name="username" placeholder="Masukkan Nama Pengguna" class="form-control fst-italic  br-10" aria-describedby="username">
                                </div>
                                ...
                                <button type="button" class="btn btn-white fw-bold br-15 mb-4" data-bs-toggle="modal" data-bs-target="#myModal">Masuk</button>

                                <div class="form-group">
                                    <center>
                                        <img src="../img/google.png" width="59px" class="ms-3" alt="">
                                    </center>
